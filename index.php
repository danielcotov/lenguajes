        ...
        <div class="wrapper d-flex align-items-stretch" style="font-family: 'Bogle';">
            ...
            <div id="content" class="p-4 p-md-5 pt-5">
                <div class="containericon" style="top: 100px; left: 400px">
                    <img src="resources/images/employee.png" alt="Employee" class="image" style="top: 100px; left: 400px; width: 100%;"/>
                    <div class="middle" style="  top: 115%; left: 50%;">
                        <div> 
                            <a href="empleados/lista.php" class="btn btn-success">Empleados</a>
                        </div>                       
                    </div>
                </div>
