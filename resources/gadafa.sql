...
BEGIN
    INSERT INTO PAISES
    VALUES(VCANT_PS,VPAIS);
    INSERT INTO PROVINCIAS
    VALUES(VCANT_PV,VPROVINCIA,CANTIDAD_PAISES);
    INSERT INTO CANTONES
    VALUES(VCANT_C,VCANTON,CANTIDAD_PROVINCIAS);
...
CREATE OR REPLACE PROCEDURE LISTAR_CANTONES(CUR OUT SYS_REFCURSOR)
AS
BEGIN
    OPEN CUR FOR SELECT NOMBRE
                FROM PROVINCIAS;
