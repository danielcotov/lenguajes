...
CREATE TABLE USUARIO_TMP(USUARIO VARCHAR2(50));
CREATE OR REPLACE PROCEDURE TRUNC_USUARIO
AS
PRAGMA AUTONOMOUS_TRANSACTION;
BEGIN
    EXECUTE IMMEDIATE 'TRUNCATE TABLE USUARIO_TMP';
END;
                   
CREATE TABLE AUDITORIA_PRODUCTO (FECHA DATE DEFAULT SYSDATE, ID_PRODUCTO NUMBER, 
	NOMBRE VARCHAR2(50), 
	PRECIO_UNIT NUMBER(10), 
	DESCRIPCION VARCHAR2(150), 
    CANTIDAD_INV VARCHAR2(20), 
	ID_CATEGORIA NUMBER,
    USUARIO VARCHAR2(50),
    ESTADO VARCHAR2(10));
...
AS
 CURSOR EMPLEADOS IS SELECT CORREO,PASSWORD
                    FROM EMPLEADOS;
 VFAIL EXCEPTION;
 VSUCCESS EXCEPTION;
 VCODE NUMBER;
...
BEGIN
    ...
    EXCEPTION
         WHEN VSUCCESS THEN
            ...
            INSERT INTO AUDITORIA(CODIGO,MENSAJE,USUARIO,ORIGEN) VALUES (VCODE,MENSAJE,USUARIO,'INICIO_SESION');
         WHEN VFAIL THEN
            VCODE := '-1000';
...
CREATE OR REPLACE PROCEDURE CIERRE_SESION (USUARIO IN VARCHAR2)
AS
 VEXP EXCEPTION;
 VCODE NUMBER;
 MENSAJE VARCHAR2(800);
BEGIN
    ...
    EXCEPTION
         WHEN VEXP THEN
            ...
            INSERT INTO AUDITORIA(CODIGO,MENSAJE,USUARIO,ORIGEN) VALUES (VCODE,MENSAJE,USUARIO,'CIERRE_SESION');
         WHEN OTHERS THEN
            VCODE := SQLCODE;
            MENSAJE := SQLERRM;
            INSERT INTO AUDITORIA(CODIGO,MENSAJE,USUARIO,ORIGEN) VALUES (VCODE,MENSAJE,USER,'CIERRE_SESION');
END;
...
AS
    VCANT_PV NUMBER(6) :=PROV_SEQ.NEXTVAL;
    VCANT_C NUMBER(6) := CANT_SEQ.NEXTVAL;
    VCANT_PS NUMBER(6) := PAIS_SEQ.NEXTVAL;
    VCODE NUMBER;
    MENSAJE VARCHAR2(800);
BEGIN
...
CREATE OR REPLACE PROCEDURE ACTUALIZAR_PRODUCTO(VID IN NUMBER,VNOMBRE IN VARCHAR2,VPRECIO IN VARCHAR2,VDESCRIPCION IN VARCHAR2, 
                                            VCANTIDAD IN VARCHAR2, VCATEGORIA IN VARCHAR2, USUARIO IN VARCHAR2)
AS
    VCANT_CV NUMBER(6) :=CATE_SEQ.NEXTVAL;
    VCODE NUMBER;
    MENSAJE VARCHAR2(800);
BEGIN
    ...
    INSERT INTO USUARIO_TMP VALUES (USUARIO);  
    COMMIT;
    UPDATE PRODUCTOS
    SET NOMBRE = VNOMBRE,
    PRECIO_UNIT = VPRECIO,
    ...
    WHEN OTHERS THEN
        VCODE := SQLCODE;
        MENSAJE := SQLERRM;
        INSERT INTO AUDITORIA(CODIGO,MENSAJE,USUARIO,ORIGEN) VALUES (VCODE,MENSAJE,USUARIO,'ACTUALIZAR_PRODUCTO');
        COMMIT;
END;
...
INSERT INTO EMPLEADOS VALUES(1,'test','Fabian','Bolanos','Dir',1,'fabian',1234,'M','19/JAN/1997','19/APR/2007',100);
INSERT INTO EMPLEADOS VALUES(2,'test','Daniel','Coto','Dir',1,'daniel',1234,'M','24/JAN/1993','19/APR/2007',100);
INSERT INTO EMPLEADOS VALUES(3,'test','Gabriel','Duarte','Dir',1,'gabriel',1234,'M','19/JAN/1997','19/APR/2007',100);


CREATE OR REPLACE PROCEDURE LISTAR_EMPLEADOS(CUR OUT SYS_REFCURSOR)
AS
    VCODE NUMBER;
    MENSAJE VARCHAR2(800);
BEGIN
    OPEN CUR FOR SELECT U.ID_USUARIO ID,
                ...
                PV.NOMBRE PROVINCIA,
                PS.NOMBRE PAIS
                FROM EMPLEADOS U, CANTONES C, PROVINCIAS PV, PAISES PS
    ...
    EXCEPTION
        WHEN OTHERS THEN
            VCODE := SQLCODE;
            MENSAJE := SQLERRM;
            INSERT INTO AUDITORIA(CODIGO,MENSAJE,USUARIO,ORIGEN) VALUES (VCODE,MENSAJE,USER,'LISTAR_EMPLEADOS');
END;

CREATE OR REPLACE PROCEDURE LISTAR_EMPLEADO(VID IN NUMBER, NOMBRE OUT VARCHAR2,APELLIDO OUT VARCHAR2,CORREO OUT VARCHAR2,
...
AS
 CURSOR EMPLEADOS IS  SELECT U.ID_USUARIO ID,
                            U.NOMBRE NOMBRE,
                            U.APELLIDO APELLIDO,
                            U.CORREO CORREO,
...
BEGIN
    ...
    EXCEPTION
        WHEN OTHERS THEN
            VCODE := SQLCODE;
            MENSAJE := SQLERRM;
            INSERT INTO AUDITORIA(CODIGO,MENSAJE,USUARIO,ORIGEN) VALUES (VCODE,MENSAJE,USER,'LISTAR_EMPLEADO');     
END;


CREATE OR REPLACE PROCEDURE ACTUALIZAR_EMPLEADO(VID IN NUMBER,VNOMBRE IN VARCHAR2,VAPELLIDO IN VARCHAR2,VCORREO IN VARCHAR2,
...
BEGIN
    ...
    WHEN OTHERS THEN
        VCODE := SQLCODE;
        MENSAJE := SQLERRM;
        INSERT INTO AUDITORIA(CODIGO,MENSAJE,USUARIO,ORIGEN) VALUES (VCODE,MENSAJE,USER,'ACTUALIZAR_EMPLEADO');
END;
...
BEGIN
 ...
 EXCEPTION
    WHEN OTHERS THEN
        VCODE := SQLCODE;
        MENSAJE := SQLERRM;
        INSERT INTO AUDITORIA(CODIGO,MENSAJE,USUARIO,ORIGEN) VALUES (VCODE,MENSAJE,USER,'CANTIDAD_EMPLEADOS');
END;
...
CREATE OR REPLACE PROCEDURE INSERTAR_EMPLEADO(VID IN NUMBER,VNOMBRE IN VARCHAR2,VAPELLIDO IN VARCHAR2,VCORREO IN VARCHAR2,
                                            VCONTRASENA IN VARCHAR2, VTELEFONO IN NUMBER,VDIRECCION IN VARCHAR2,
                                            VCANTON IN VARCHAR2, VPROVINCIA IN VARCHAR2, VPAIS IN VARCHAR2, VGENERO IN CHAR,
                                            VFECHA_NACIMIENTO IN DATE,VFECHA_INGRESO IN DATE, VSALARIO IN NUMBER)
AS
...
BEGIN
    ...
    EXCEPTION
        WHEN OTHERS THEN
            VCODE := SQLCODE;
            MENSAJE := SQLERRM;
            INSERT INTO AUDITORIA(CODIGO,MENSAJE,USUARIO,ORIGEN) VALUES (VCODE,MENSAJE,USER,'INSERTAR_EMPLEADO');
END;
...
AS
    ...
    MENSAJE VARCHAR2(800);
BEGIN
    FOR C IN(SELECT ID_USUARIO FROM EMPLEADOS
...
BEGIN
    ...
    FOR C IN(SELECT ID_USUARIO, NOMBRE, APELLIDO, FECHA_INGRESO,SALARIO FROM EMPLEADOS)    
    LOOP
...
EXCEPTION
    WHEN OTHERS THEN
        VCODE := SQLCODE;
        MENSAJE := SQLERRM;
        INSERT INTO AUDITORIA(CODIGO,MENSAJE,USUARIO,ORIGEN) VALUES (VCODE,MENSAJE,USER,'ELIMINAR_EMPLEADO');
END;
...
CREATE OR REPLACE PROCEDURE REPORTE_ACCESO (CUR OUT SYS_REFCURSOR)
AS
BEGIN
    OPEN CUR FOR SELECT TO_CHAR(FECHA,'DD-MM-YYYY HH24:MI:SS') FECHA, USUARIO, MENSAJE 
                 FROM AUDITORIA
                 WHERE CODIGO IN(1000,-1000, 1001)
                 ORDER BY FECHA DESC;
END;


CREATE OR REPLACE TRIGGER CAMBIO_PRODUCTO
...
BEGIN
    ...
    FROM USUARIO_TMP;
    VCODE := '2001';
    MENSAJE := 'SE REALIZARON CAMBIOS EN EL PRODUCTO ' || :old.nombre;
    INSERT INTO AUDITORIA(CODIGO,MENSAJE,USUARIO,ORIGEN) VALUES (VCODE,MENSAJE,USUARIO,'CAMBIO_PRODUCTO');
    INSERT INTO AUDITORIA_PRODUCTO (ID_PRODUCTO,NOMBRE,PRECIO_UNIT,DESCRIPCION,CANTIDAD_INV,ID_CATEGORIA,USUARIO,ESTADO)
    VALUES (:OLD.ID_PRODUCTO,:OLD.NOMBRE,:OLD.PRECIO_UNIT,:OLD.DESCRIPCION,:OLD.CANTIDAD_INV,:OLD.ID_CATEGORIA,USUARIO,'ORIGINAL');
    INSERT INTO AUDITORIA_PRODUCTO (ID_PRODUCTO,NOMBRE,PRECIO_UNIT,DESCRIPCION,CANTIDAD_INV,ID_CATEGORIA,USUARIO,ESTADO)
    VALUES (:NEW.ID_PRODUCTO,:NEW.NOMBRE,:NEW.PRECIO_UNIT,:NEW.DESCRIPCION,:NEW.CANTIDAD_INV,:NEW.ID_CATEGORIA,USUARIO,'NUEVO');
END;

CREATE OR REPLACE PROCEDURE REPORTE_CAMBIOS_PRODUCTO(CUR OUT SYS_REFCURSOR)
AS
BEGIN
    OPEN CUR FOR SELECT TO_CHAR(FECHA,'DD-MM-YYYY HH24:MI:SS') FECHA, USUARIO, ID_PRODUCTO, NOMBRE, PRECIO_UNIT, DESCRIPCION, CANTIDAD_INV, ID_CATEGORIA, ESTADO
...
CREATE OR REPLACE PROCEDURE AUDITORIA_GENERAL(CUR OUT SYS_REFCURSOR)
AS
BEGIN
    OPEN CUR FOR SELECT TO_CHAR(FECHA,'DD-MM-YYYY HH24:MI:SS') FECHA, USUARIO, MENSAJE 
                 FROM AUDITORIA
...
ALTER TABLE EMPLEADOS MODIFY (SALARIO NOT NULL);
...
MINVALUE 1
MAXVALUE 1000;
    select cate_SEQ.currval from dual
